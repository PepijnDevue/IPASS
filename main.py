...
def open_menu(window):
    ...
    def on_mouse_press(x,y, button, modifiers):
        if(x > pvp_button.x and x < pvp_button.x+pvp_button.width and y > pvp_button.y and y < pvp_button.y+pvp_button.height):
            print("PVP")
        elif(x > pve_button.x and x < pve_button.x+pve_button.width and y > pve_button.y and y < pve_button.y+pve_button.height):
            print("PVE")
